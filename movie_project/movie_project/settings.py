...
import os  # Добавьте эту строку в начало!
...
SECRET_KEY = 'django-insecure-yfj4+=n3*aoxvtxz)di3r+9xpk-a*z*mz=qx1qqvq@qv5=zp0e'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates')],  # Путь к базовым шаблонам
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
